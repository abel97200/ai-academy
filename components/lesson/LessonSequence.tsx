...
// quand la pédagogie exige un déroulé narratif précis (ex: ne nommer un
// terme technique qu'après plusieurs manipulations), ce que le
// regroupement par type ne peut pas garantir : un bloc "explication"
// finirait toujours dans l'onglet "Comprendre", même écrit après des
// blocs "Essayer".
//
